...
if(!empty($id))
{
	...
	$cont_obj->updateTrending($data);
?> 
	<a href='javascript:void(0);' data-url="content/load/change-trending?status=<?php echo $status;?>&id=<?php echo $id;?>" data-action="add" data-container="#activate_<?php echo
	$id;?>"
