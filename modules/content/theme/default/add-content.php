...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $('.content_block').click(function(){
            ...
            } else if(dtype == 'feature') {
                html += '<label for="'+dtype+'_'+count+'" class="control-label col-lg-2">Studio Features:</label><div class="col-lg-7 row"><div class="col-lg-10 row"><input type="text" name="'+dtype+'_title['+count+']" id="'+dtype+'_title_'+count+'" maxlength="100" value="" class="form-control" placeholder="Heading" /></div><div class="col-lg-10 row"><input type="text" name="'+dtype+'_desc['+count+']" id="'+dtype+'_desc_'+count+'" maxlength="100" value="" class="form-control" placeholder="Short Description" /></div><div class="col-lg-10 row">Feature listing for this studio is enabled.<br /><small><strong>Note:</strong> Feature listing block is only displayed for studios.</small></div></div>';
            } else if(dtype == 'trending') {
                html += '<label for="'+dtype+'_'+count+'" class="control-label col-lg-2">Studio Trending:</label><div class="col-lg-7 row"><div class="col-lg-10 row"><input type="text" name="'+dtype+'_title['+count+']" id="'+dtype+'_title_'+count+'" maxlength="100" value="" class="form-control" placeholder="Heading" /></div><div class="col-lg-10 row"><input type="text" name="'+dtype+'_desc['+count+']" id="'+dtype+'_desc_'+count+'" maxlength="100" value="" class="form-control" placeholder="Short Description" /></div><div class="col-lg-10 row">Trending for this studio is enabled.<br /><small><strong>Note:</strong> Trending block is only displayed for studios.</small></div></div>';
            } else if(dtype == 'map') {
